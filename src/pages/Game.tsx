...
export function Game() {
  ...
  const handleSendMessage = async (content: string) => {
    ...
    try {
      ...
      const solved = answer === '�? && isSolvedGuess(content, story)
      ...
      <section className="relative overflow-hidden rounded-lg border border-emerald-400/20 bg-black/35 p-3.5 shadow-lg shadow-emerald-950/25 transition duration-300 sm:p-4">
        ...
        <div className="relative z-10 flex flex-col gap-2.5 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-col items-start gap-3 lg:items-end">
            ...
            <div className="flex flex-wrap gap-2 lg:justify-end">
              <button
                className="rounded-lg border border-amber-400/50 bg-amber-400/10 px-4 py-2.5 text-sm font-semibold text-amber-300 transition duration-200 hover:-translate-y-px hover:bg-amber-400/20 hover:shadow-lg hover:shadow-amber-950/25"
              ...
              <button
                className="rounded-lg border border-stone-700 bg-stone-900/80 px-4 py-2.5 text-sm font-semibold text-stone-200 transition duration-200 hover:-translate-y-px hover:border-stone-500 hover:shadow-lg hover:shadow-stone-950/30"
                onClick={handleQuit}
                type="button"
              >
                结束游戏
              ...
              <Link
                className="rounded-lg border border-rose-400/35 bg-rose-500/10 px-4 py-2.5 text-center text-sm font-semibold text-rose-200 transition duration-200 hover:-translate-y-px hover:bg-rose-500/20 hover:shadow-lg hover:shadow-rose-950/25"
                state={{ view: 'lobby' }}
                to="/"
              >
                返回大厅
